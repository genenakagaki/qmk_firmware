...
TO(0)   , LSFT_T(KC_F1) , LCTL_T(KC_F2) , LALT_T(KC_F3) , LGUI_T(KC_F4) , KC_F5   , KC_LEFT , RGUI_T(KC_DOWN) , RALT_T(KC_UP) , RCTL_T(KC_RIGHT) , KC_BSPC , KC_ENT ,
...
KC_TRNS , KC_QUOT , KC_COMM , KC_DOT  , XXXXXXX , XXXXXXX , LSFT(KC_8) , KC_7 , KC_8    , KC_9 , XXXXXXX        , KC_BSPC ,
...
TO(0)   , KC_GRV       , KC_LPRN    , KC_RPRN    , KC_LCBR       , KC_BSLS       , LSFT(KC_SLSH) , XXXXXXX    , XXXXXXX , XXXXXXX , XXXXXXX , KC_ENT  ,
